...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    video_out_pynq_z2_v_tpg_0_0_hls_deadlock_detect_unit #(4, 0, 3, 3) video_out_pynq_z2_v_tpg_0_0_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    video_out_pynq_z2_v_tpg_0_0_hls_deadlock_detect_unit #(4, 1, 2, 2) video_out_pynq_z2_v_tpg_0_0_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    video_out_pynq_z2_v_tpg_0_0_hls_deadlock_detect_unit #(4, 2, 3, 3) video_out_pynq_z2_v_tpg_0_0_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    video_out_pynq_z2_v_tpg_0_0_hls_deadlock_detect_unit #(4, 3, 2, 2) video_out_pynq_z2_v_tpg_0_0_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
...
`include "video_out_pynq_z2_v_tpg_0_0_hls_deadlock_report_unit.vh"

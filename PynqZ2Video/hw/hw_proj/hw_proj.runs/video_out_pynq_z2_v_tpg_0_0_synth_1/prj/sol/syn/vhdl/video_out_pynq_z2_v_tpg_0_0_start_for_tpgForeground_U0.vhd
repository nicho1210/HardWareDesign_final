...
architecture rtl of video_out_pynq_z2_v_tpg_0_0_start_for_tpgForeground_U0 is

    component video_out_pynq_z2_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_video_out_pynq_z2_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg : video_out_pynq_z2_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg
    generic map (
...
entity video_out_pynq_z2_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end video_out_pynq_z2_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg;

architecture rtl of video_out_pynq_z2_v_tpg_0_0_start_for_tpgForeground_U0_ShiftReg is

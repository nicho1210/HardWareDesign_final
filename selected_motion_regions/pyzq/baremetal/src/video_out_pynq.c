...
static void print_motion_grid(u32 mask)
{
    xil_printf("motion grid:\r\n");
    xil_printf("  Index grid           Binary grid\r\n");
...
int main(void)
{
    ...
    motion_mask  = (motion_info >> 16) & 0xFFFF;

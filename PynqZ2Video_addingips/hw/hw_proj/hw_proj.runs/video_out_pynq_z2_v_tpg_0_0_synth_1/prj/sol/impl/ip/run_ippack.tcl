...
set IPName      "v_tpg"
set Version     "8.2"
set DisplayName "V_tpg"
set Revision    "2114569701"
...
set xo_kernel_name "v_tpg"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/selected_topics_final_saved_again/PynqZ2Video/hw/hw_proj/hw_proj.runs/video_out_pynq_z2_v_tpg_0_0_synth_1/prj/sol"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/selected_topics_final_saved_again/PynqZ2Video/hw/hw_proj/hw_proj.runs/video_out_pynq_z2_v_tpg_0_0_synth_1/prj/sol/.debug"
set xo_hls_files_dir ""
set hdl_module_list {video_out_pynq_z2_v_tpg_0_0_urem_11ns_4ns_3_15_1
...
video_out_pynq_z2_v_tpg_0_0_flow_control_loop_pipe_sequential_init
video_out_pynq_z2_v_tpg_0_0_tpgForeground_Pipeline_VITIS_LOOP_774_2_whiYuv_2_ROM_AUTO_1R
video_out_pynq_z2_v_tpg_0_0_flow_control_loop_pipe_sequential_init
video_out_pynq_z2_v_tpg_0_0_fifo_w16_d4_S
video_out_pynq_z2_v_tpg_0_0_fifo_w1_d4_S
video_out_pynq_z2_v_tpg_0_0_fifo_w8_d3_S
video_out_pynq_z2_v_tpg_0_0_fifo_w8_d3_S
video_out_pynq_z2_v_tpg_0_0_fifo_w16_d3_S
video_out_pynq_z2_v_tpg_0_0_fifo_w16_d3_S
video_out_pynq_z2_v_tpg_0_0_fifo_w16_d3_S
video_out_pynq_z2_v_tpg_0_0_fifo_w8_d3_S
video_out_pynq_z2_v_tpg_0_0_fifo_w8_d3_S
video_out_pynq_z2_v_tpg_0_0_fifo_w8_d3_S
video_out_pynq_z2_v_tpg_0_0_fifo_w24_d16_S
video_out_pynq_z2_v_tpg_0_0_fifo_w16_d2_S
video_out_pynq_z2_v_tpg_0_0_fifo_w16_d2_S
video_out_pynq_z2_v_tpg_0_0_fifo_w8_d2_S
video_out_pynq_z2_v_tpg_0_0_fifo_w8_d2_S
video_out_pynq_z2_v_tpg_0_0_fifo_w24_d16_S
video_out_pynq_z2_v_tpg_0_0_fifo_w12_d2_S
video_out_pynq_z2_v_tpg_0_0_fifo_w13_d2_S
video_out_pynq_z2_v_tpg_0_0_fifo_w8_d2_S
video_out_pynq_z2_v_tpg_0_0_start_for_tpgForeground_U0
video_out_pynq_z2_v_tpg_0_0_start_for_MultiPixStream2AXIvideo_U0
video_out_pynq_z2_v_tpg_0_0_CTRL_s_axi
video_out_pynq_z2_v_tpg_0_0_regslice_both
video_out_pynq_z2_v_tpg_0_0_regslice_both
video_out_pynq_z2_v_tpg_0_0_regslice_both
video_out_pynq_z2_v_tpg_0_0_regslice_both
video_out_pynq_z2_v_tpg_0_0_regslice_both
...
set kernel_xo ""
set detect_deadlock_json "video_out_pynq_z2_v_tpg_0_0_v_tpg_message_dict.json"

## Variables
set Top "video_out_pynq_z2_v_tpg_0_0_v_tpg"
set TopNoPrefix "v_tpg"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 height W 0x0 "Data signal of height" {{0 16 height W 0 "Bit 15 to 0 of height"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 width W 0x0 "Data signal of width" {{0 16 width W 0 "Bit 15 to 0 of width"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 bckgndId W 0x0 "Data signal of bckgndId" {{0 8 bckgndId W 0 "Bit 7 to 0 of bckgndId"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 ovrlayId W 0x0 "Data signal of ovrlayId" {{0 8 ovrlayId W 0 "Bit 7 to 0 of ovrlayId"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 maskId W 0x0 "Data signal of maskId" {{0 8 maskId W 0 "Bit 7 to 0 of maskId"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 motionSpeed W 0x0 "Data signal of motionSpeed" {{0 8 motionSpeed W 0 "Bit 7 to 0 of motionSpeed"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 colorFormat W 0x0 "Data signal of colorFormat" {{0 8 colorFormat W 0 "Bit 7 to 0 of colorFormat"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 crossHairX W 0x0 "Data signal of crossHairX" {{0 16 crossHairX W 0 "Bit 15 to 0 of crossHairX"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 crossHairY W 0x0 "Data signal of crossHairY" {{0 16 crossHairY W 0 "Bit 15 to 0 of crossHairY"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 ZplateHorContStart W 0x0 "Data signal of ZplateHorContStart" {{0 16 ZplateHorContStart W 0 "Bit 15 to 0 of ZplateHorContStart"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 ZplateHorContDelta W 0x0 "Data signal of ZplateHorContDelta" {{0 16 ZplateHorContDelta W 0 "Bit 15 to 0 of ZplateHorContDelta"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 ZplateVerContStart W 0x0 "Data signal of ZplateVerContStart" {{0 16 ZplateVerContStart W 0 "Bit 15 to 0 of ZplateVerContStart"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 ZplateVerContDelta W 0x0 "Data signal of ZplateVerContDelta" {{0 16 ZplateVerContDelta W 0 "Bit 15 to 0 of ZplateVerContDelta"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 boxSize W 0x0 "Data signal of boxSize" {{0 16 boxSize W 0 "Bit 15 to 0 of boxSize"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 boxColorR W 0x0 "Data signal of boxColorR" {{0 16 boxColorR W 0 "Bit 15 to 0 of boxColorR"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 boxColorG W 0x0 "Data signal of boxColorG" {{0 16 boxColorG W 0 "Bit 15 to 0 of boxColorG"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 boxColorB W 0x0 "Data signal of boxColorB" {{0 16 boxColorB W 0 "Bit 15 to 0 of boxColorB"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xc0 dpDynamicRange W 0x0 "Data signal of dpDynamicRange" {{0 8 dpDynamicRange W 0 "Bit 7 to 0 of dpDynamicRange"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0xc8 dpYUVCoef W 0x0 "Data signal of dpYUVCoef" {{0 8 dpYUVCoef W 0 "Bit 7 to 0 of dpYUVCoef"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0xd0 field_id W 0x0 "Data signal of field_id" {{0 16 field_id W 0 "Bit 15 to 0 of field_id"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xd8 bck_motion_en W 0x0 "Data signal of bck_motion_en" {{0 16 bck_motion_en W 0 "Bit 15 to 0 of bck_motion_en"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 29 II x}

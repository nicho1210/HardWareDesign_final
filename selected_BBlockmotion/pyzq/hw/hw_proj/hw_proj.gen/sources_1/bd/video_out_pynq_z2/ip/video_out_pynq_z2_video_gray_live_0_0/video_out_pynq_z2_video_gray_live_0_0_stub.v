...
//               c:/selected_BBlockmotion/pyzq/hw/hw_proj/hw_proj.gen/sources_1/bd/video_out_pynq_z2/ip/video_out_pynq_z2_video_gray_live_0_0/video_out_pynq_z2_video_gray_live_0_0_stub.v
...
module video_out_pynq_z2_video_gray_live_0_0(ap_clk, ap_rst_n, in_stream_TVALID, 
  ...
  out_stream_TLAST, out_stream_TID)
/* synthesis syn_black_box black_box_pad_pin="ap_rst_n,in_stream_TVALID,in_stream_TREADY,in_stream_TDATA[23:0],in_stream_TDEST[0:0],in_stream_TKEEP[2:0],in_stream_TSTRB[2:0],in_stream_TUSER[0:0],in_stream_TLAST[0:0],in_stream_TID[0:0],out_stream_TVALID,out_stream_TREADY,out_stream_TDATA[23:0],out_stream_TDEST[0:0],out_stream_TKEEP[2:0],out_stream_TSTRB[2:0],out_stream_TUSER[0:0],out_stream_TLAST[0:0],out_stream_TID[0:0]" */

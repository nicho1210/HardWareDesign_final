...
architecture behav of video_gray_live is 
    ...
    "video_gray_live_video_gray_live,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.908000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=4,HLS_SYN_LUT=66,HLS_VERSION=2023_2}";
    ...
    signal g_fu_157_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal curr_bin_fu_167_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln56_fu_173_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_1_fu_181_p4 : STD_LOGIC_VECTOR (16 downto 0);
...
begin
    ...
    curr_bin_fu_167_p2 <= "1" when (unsigned(g_fu_157_p4) > unsigned(ap_const_lv8_5F)) else "0";
    g_fu_157_p4 <= in_stream_TDATA_int_regslice(15 downto 8);
    ...
    begin
        ...
        out_stream_TDATA_int_regslice <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_1_fu_181_p4),24));
    ...
    select_ln56_fu_173_p3 <= 
        ap_const_lv8_FF when (curr_bin_fu_167_p2(0) = '1') else 
        ap_const_lv8_0;
    tmp_1_fu_181_p4 <= ((curr_bin_fu_167_p2 & select_ln56_fu_173_p3) & select_ln56_fu_173_p3);
end behav;

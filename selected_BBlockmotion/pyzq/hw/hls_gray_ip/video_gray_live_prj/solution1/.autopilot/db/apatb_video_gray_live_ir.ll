; ModuleID = 'C:/selected_topics_hdmi/pyzq/hw/hls_gray_ip/video_gray_live_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_video_gray_live_ir(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(12) %in_stream, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(12) %out_stream) local_unnamed_addr #0 {
entry:
  %in_stream_copy.data = alloca i24, align 512
  %in_stream_copy.keep = alloca i3, align 512
  %in_stream_copy.strb = alloca i3, align 512
  ...
  %out_stream_copy.data = alloca i24, align 512
  %out_stream_copy.keep = alloca i3, align 512
  %out_stream_copy.strb = alloca i3, align 512
  ...
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %in_stream, i24* nonnull align 512 %in_stream_copy.data, i3* nonnull align 512 %in_stream_copy.keep, i3* nonnull align 512 %in_stream_copy.strb, i1* nonnull align 512 %in_stream_copy.user, i1* nonnull align 512 %in_stream_copy.last, i1* nonnull align 512 %in_stream_copy.id, i1* nonnull align 512 %in_stream_copy.dest, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %out_stream, i24* nonnull align 512 %out_stream_copy.data, i3* nonnull align 512 %out_stream_copy.keep, i3* nonnull align 512 %out_stream_copy.strb, i1* nonnull align 512 %out_stream_copy.user, i1* nonnull align 512 %out_stream_copy.last, i1* nonnull align 512 %out_stream_copy.id, i1* nonnull align 512 %out_stream_copy.dest)
  call void @apatb_video_gray_live_hw(i24* %in_stream_copy.data, i3* %in_stream_copy.keep, i3* %in_stream_copy.strb, i1* %in_stream_copy.user, i1* %in_stream_copy.last, i1* %in_stream_copy.id, i1* %in_stream_copy.dest, i24* %out_stream_copy.data, i3* %out_stream_copy.keep, i3* %out_stream_copy.strb, i1* %out_stream_copy.user, i1* %out_stream_copy.last, i1* %out_stream_copy.id, i1* %out_stream_copy.dest)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %in_stream, i24* %in_stream_copy.data, i3* %in_stream_copy.keep, i3* %in_stream_copy.strb, i1* %in_stream_copy.user, i1* %in_stream_copy.last, i1* %in_stream_copy.id, i1* %in_stream_copy.dest, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %out_stream, i24* %out_stream_copy.data, i3* %out_stream_copy.keep, i3* %out_stream_copy.strb, i1* %out_stream_copy.user, i1* %out_stream_copy.last, i1* %out_stream_copy.id, i1* %out_stream_copy.dest)
  ret void
}
...
declare void @apatb_video_gray_live_hw(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i24*, i3*, i3*, i1*, i1*, i1*, i1*)
...
define void @video_gray_live_hw_stub_wrapper(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i24*, i3*, i3*, i1*, i1*, i1*, i1*) #5 {
entry:
  %14 = alloca %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"
  %15 = alloca %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %14, i24* %0, i3* %1, i3* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %15, i24* %7, i3* %8, i3* %9, i1* %10, i1* %11, i1* %12, i1* %13)
  call void @video_gray_live_hw_stub(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %14, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %15)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %14, i24* %0, i3* %1, i3* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %15, i24* %7, i3* %8, i3* %9, i1* %10, i1* %11, i1* %12, i1* %13)
  ret void
}

declare void @video_gray_live_hw_stub(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"*, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"*)

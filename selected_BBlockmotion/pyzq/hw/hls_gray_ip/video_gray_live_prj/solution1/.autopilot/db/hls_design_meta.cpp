...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("out_stream_TDATA", 24, hls_out, 7, "axis", "out_data", 1),
	Port_Property("out_stream_TVALID", 1, hls_out, 13, "axis", "out_vld", 1),
	Port_Property("out_stream_TREADY", 1, hls_in, 7, "axis", "out_acc", 1),
	Port_Property("out_stream_TKEEP", 3, hls_out, 8, "axis", "out_data", 1),
	Port_Property("out_stream_TSTRB", 3, hls_out, 9, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "video_gray_live";

...
# RegSlice definition:
set ID 15
set RegSliceName video_gray_live_regslice_both
set RegSliceInstName video_gray_live_regslice_both_U
set CoreName ap_simcore_video_gray_live_regslice_both

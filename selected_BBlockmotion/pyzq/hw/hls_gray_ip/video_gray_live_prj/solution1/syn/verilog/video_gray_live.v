...
wire   [7:0] g_fu_157_p4;
wire   [0:0] curr_bin_fu_167_p2;
wire   [7:0] select_ln56_fu_173_p3;
wire   [16:0] tmp_1_fu_181_p4;
reg   [1:0] ap_NS_fsm;
...
assign curr_bin_fu_167_p2 = ((g_fu_157_p4 > 8'd95) ? 1'b1 : 1'b0);

assign g_fu_157_p4 = {{in_stream_TDATA_int_regslice[15:8]}};

assign in_stream_TREADY = regslice_both_in_stream_V_data_V_U_ack_in;

assign out_stream_TDATA_int_regslice = $signed(tmp_1_fu_181_p4);

assign out_stream_TVALID = regslice_both_out_stream_V_data_V_U_vld_out;

assign select_ln56_fu_173_p3 = ((curr_bin_fu_167_p2[0:0] == 1'b1) ? 8'd255 : 8'd0);

assign tmp_1_fu_181_p4 = {{{curr_bin_fu_167_p2}, {select_ln56_fu_173_p3}}, {select_ln56_fu_173_p3}};
